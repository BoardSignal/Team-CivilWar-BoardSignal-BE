...
public class BoardGameService {
    ...
    public BoardGamePageResponse<GetAllBoardGamesResponse> getAllBoardGames(BoardGameSearchCondition condition, Pageable pageable){
        Page<BoardGame> boardGames = boardGameQueryRepository.findAll(condition, pageable);
        Page<GetAllBoardGamesResponse> findBoardGames = boardGames.map(BoardGameMapper::toGetAllBoardGamesResponse); // 응답 dto 형식으로 변환
